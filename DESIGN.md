...
- The series page cannot name a team side. `SeriesPublic` carries the players and the fixture alone, so `GET /series/{id}` answers no entrant and no team; the box there reads "To be decided" until that payload carries them.
