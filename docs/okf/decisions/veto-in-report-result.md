...
Since 2026-09-20 the dialog checks the replays against the veto: a replay played on a map the veto gives another game warns beside its game and names the game to move it to, and saving asks once, with "Report anyway" and "Go back", when a replay disagrees with the veto, or when the series plays a veto and records no step. The question is asked once and never refuses.
