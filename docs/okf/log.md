...
* **Update**: a data display concept states how a form, a colour and a race are chosen for league data; `DESIGN.md` gains the table of questions and pieces, the measured colour values and the validator step.
