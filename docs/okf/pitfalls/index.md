...
* [A proxy route must drop the encoding headers of the answer](proxy-answer-keeps-encoding-header.md) - Node fetch unpacks a compressed answer but keeps its content-encoding header; a route that passes the answer on unchanged sends a body the browser cannot decode.
