...
export function TeamView({ id }: { id: string }) {
  ...
  return <div className="p-4">
    ...
    {team ? <TeamRoster captains={roster.captains} members={roster.members} series={series} rounds={seasonRow?.round_count ?? 0} round={roundInPlay?.playday ?? null} eventId={seasonId} /> : null}
  </div>;
}
