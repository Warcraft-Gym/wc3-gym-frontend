...
export const router = createRouter({
    ...
    routes: [
        ...
        { path: '/upcoming', component: UpcomingView, meta: { role: 'member' } },
        ...
        { path: '/leagues', component: LeaguesView, meta: { role: 'public' } },
        { path: '/leagues/:id', component: LeagueView, meta: { role: 'public' } },
        { path: '/events', component: EventsView, meta: { role: 'public' } },
        ...
        { path: '/events/:id', component: EventView, meta: { role: 'public' } },
