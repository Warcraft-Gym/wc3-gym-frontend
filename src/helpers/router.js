...
export const router = createRouter({
    ...
    routes: [
        ...
        { path: '/signup', component: PublicSignupView, meta: { role: 'public' } },
        { path: '/player-dashboard', component: PlayerDashboardView, meta: { role: 'public' } },
        { path: '/player-series/:id/veto', component: VetoBoardView, meta: { role: 'public' } },
        ...
        { path: '/team/:id/season/:season_id/weeks', component: TeamWeeksView, meta: { role: 'captain', season: true } },
